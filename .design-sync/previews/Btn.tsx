...
export const Variants = () => (
  <div className="welcome" style={{ display: "flex", gap: 10, alignItems: "center", padding: 16, width: "auto", maxHeight: "none", borderRadius: 0, boxShadow: "none", border: "none", background: "none", animation: "none" }}>
...
export const WithIcons = () => (
  <div className="welcome" style={{ display: "flex", gap: 10, alignItems: "center", padding: 16, width: "auto", maxHeight: "none", borderRadius: 0, boxShadow: "none", border: "none", background: "none", animation: "none" }}>
    ...
    <Btn variant="soft" icon="brain">Distill</Btn>
    <Btn variant="ghost" iconRight="chevronRight">See all cards</Btn>
    <Btn variant="ghost" icon="postpone" iconRight="chevronDown">Postpone</Btn>
  </div>
);
