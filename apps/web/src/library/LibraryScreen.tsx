...
/**
 * The read-only concept map. Lays concepts out on a simple radial ring around
 * the most-connected root (deterministic, no persisted layout — the MVP map is
 * read-only). Clicking a node filters the results by that concept.
 */
