...
function bootstrap(): void {
  ...
  dbService.open(paths.dbPath, {
    ...
    // App-data diagnostics logs dir (U3): main appends on-device embedding model-load
    // failures to `<logsDir>/embedding.log` so a silent fallback is diagnosable offline.
